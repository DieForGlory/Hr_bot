TEXTS = {
    "ru": {
        ...
        # --- Регистрация: иерархический выбор + выбор себя из справочника (п.7/8) ---
        "reg_choose_department_hint": "Сотрудник не найден по номеру телефона. Пройдите регистрацию: найдите своё подразделение, двигаясь по уровням оргструктуры, и выберите себя из списка.",
        "reg_choose_top": "Выберите департамент:",
        "reg_nav_back": "◀️ Назад",
        "reg_not_in_list": "🙋 Меня нет в списке",
        "reg_self_confirm_yes": "✅ Это я",
        "reg_self_confirm_prompt": "Вы выбрали:\n\nФИО: {full_name}\nДолжность: {position}\nПодразделение: {department}\n\nПодтвердите, что это вы:",
        ...
        "vacation_type_marriage": "Отпуск в связи с бракосочетанием",
        "vacation_type_childbirth": "Отпуск в связи с рождением ребенка",
        "vacation_doc_request": "Пожалуйста, прикрепите подтверждающие документы (скан или фотографию документа в хорошем качестве).",
        "vacation_doc_invalid": "Пожалуйста, прикрепите документ — фотографию или файл (PDF/скан).",
        "vacation_doc_received": "Документ получен. Заявка направлена на согласование.",
        ...
        "vacation_balance_detail": "Ваш остаток отпускных дней:\n• Рабочие дни (до 30.04.2023): {work}\n• Календарные дни (с 01.05.2023): {cal}\n• Итого: {total}\nДоп. дни за стаж (справочно): {bonus}",
        ...
        "vacation_approved_final": "Ваш отпуск согласован. Дата вашего возвращения из отпуска - {return_date}. Желаем хорошего отдыха! 😊",
        ...
        "vacation_last_day": "И не забудьте - сегодня пора морально готовиться к работе! Ваш первый рабочий день после отпуска - {return_date} 😉",
    ...
    "uz": {
        ...
        # --- Ro'yxatdan o'tish: ierarxik tanlash + ro'yxatdan o'zini tanlash (7/8-band) ---
        "reg_choose_department_hint": "Xodim telefon raqami bo'yicha topilmadi. Ro'yxatdan o'ting: tashkiliy tuzilma bo'yicha harakatlanib, o'z bo'linmangizni toping va ro'yxatdan o'zingizni tanlang.",
        "reg_choose_top": "Departamentni tanlang:",
        "reg_nav_back": "◀️ Orqaga",
        "reg_not_in_list": "🙋 Men ro'yxatda yo'qman",
        "reg_self_confirm_yes": "✅ Bu men",
        "reg_self_confirm_prompt": "Siz tanladingiz:\n\nF.I.Sh.: {full_name}\nLavozimi: {position}\nBo'linma: {department}\n\nBu siz ekanligingizni tasdiqlang:",
        ...
        "vacation_type_marriage": "Nikoh munosabati bilan ta'til",
        "vacation_type_childbirth": "Bola tug'ilishi munosabati bilan ta'til",
        "vacation_doc_request": "Iltimos, tasdiqlovchi hujjatlarni biriktiring (hujjatning skani yoki sifatli fotosurati).",
        "vacation_doc_invalid": "Iltimos, hujjatni biriktiring — fotosurat yoki fayl (PDF/skan).",
        "vacation_doc_received": "Hujjat qabul qilindi. Ariza tasdiqlashga yuborildi.",
        ...
        "vacation_balance_detail": "Ta'til kunlaringiz qoldig'i:\n• Ish kunlari (30.04.2023 gacha): {work}\n• Kalendar kunlar (01.05.2023 dan): {cal}\n• Jami: {total}\nStaj uchun qo'shimcha kunlar (ma'lumot): {bonus}",
        ...
        "vacation_approved_final": "Ta'tilingiz tasdiqlandi. Ta'tildan qaytish sanangiz - {return_date}. Yaxshi dam olishingizni tilaymiz! 😊",
        ...
        "vacation_last_day": "Va unutmang - bugun ishga ruhan tayyorlanish vaqti keldi! Ta'tildan keyingi birinchi ish kuningiz - {return_date} 😉",
        "comment_label": "Izoh",
